...
const DashboardUser = () => {
  ...
  const getdistance = (lat1, lon1, lat2, lon2) => {
    ...
    var dLat = (lat2 * Math.PI) / 180 - (lat1 * Math.PI) / 180; //διαφορα lat και μετατροπη απο μοιρες σε rad
    var dLon = (lon2 * Math.PI) / 180 - (lon1 * Math.PI) / 180; //διαφορα lon και μετατροπη απο μοιρες σε rad
    var a =
